...
public final class messageToClient_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <div style=\"text-align: center; font-weight: bold; text-decoration: underline; font-size: x-large; margin-top: 10px;\">\n");
      out.write("        ");
      out.print((String)request.getSession().getAttribute("messageType"));
      out.write("\n");
      out.write("    </div>\n");
      out.write("        <div style=\"text-align: center; margin-top: 15px;\">\n");
      out.write("            <p>");
      out.print((String)request.getSession().getAttribute("messageContent"));
      out.write("</p>\n");
